...
%  \resumeSubHeadingListStart
    \resumeItemListStart
     ...
     \resumeItem {Raised funding from Eric Schmidt (Google ex-CEO) for Picolo Labs. Awarded NSF Research Grant for startup innovation.}
   \resumeItemListEnd
%  \resumeSubHeadingListEnd
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Bachelor of Technology}{Awarded President's Gold Medal}
  \resumeSubHeadingListEnd
