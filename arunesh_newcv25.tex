...
%-----------EXPERIENCE-----------
\section{Summary}
Hands-on engineering leader with strong background in Systems, Algorithms and LLM-based agentic technologies. Looking for a leadership role in a challenging and high impact domain.
\section{Experience}
  \resumeSubHeadingListStart

    \resumeSubheading
      {Co-founder and Principal Engineer}{June 2019 -- Present}
